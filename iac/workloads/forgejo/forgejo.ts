...
const bootstrapScriptContent = fs.readFileSync(path.join(__dirname, "../../operations/maintenance/scripts/bootstrap-forgejo.sh"), "utf8");
const pruneScriptContent = fs.readFileSync(path.join(__dirname, "../../operations/maintenance/scripts/prune-forgejo-history.py"), "utf8");
